...
public class PigLatinJUnitTest {
    ...
    /*
    No set up or clean up is needed, so the @Before and @After methods are empty
    ...
    // this method tests the translation of an entire phrase using the toPigLatin() method
    @Test
    public void translatePhrase4() {
        String word = "Alexander is here";
        String actual = PigLatin.toPigLatin(word);
        String expected = "Alexanderyay isyay erehay";
        assertEquals(expected, actual);
    }
